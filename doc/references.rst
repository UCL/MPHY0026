...
This page shows a list of papers that will be covered during the course.
There are a lot of them!! During the lectures, the lecturers will
explain which papers are Key. For Key papers, you are not necessarily
expected to memorise them, just to understand the key message and be
able to apply the knowledge therein.
