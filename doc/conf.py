...
# -*- coding: utf-8 -*-
#
# MPHY0026 documentation build configuration file, created by
...
def generate_apidocs(*args):
    ...
    if hasattr(sys, 'real_prefix'):  # called from a virtualenv
        apidoc_command_path = os.path.join(sys.prefix, 'Scripts', 'sphinx-apidoc')
...
# This allows modules to be indexed under the submodule name rather than all appearing under mphy0026
...
# The short X.Y version.
# version = mphy0026.__version__
# The full version, including alpha/beta/rc tags.
# release = mphy0026.__version__
...
# To get all figures, tables referenced numerically.
numfig = True
